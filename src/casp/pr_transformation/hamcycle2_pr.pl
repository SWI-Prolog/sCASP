...
pr_rule(chosen(U,V),[vertex(U),vertex(V),edge(U,V),not(other(U,V))]).
...
pr_rule(not(o_chosen1(U,V)),[vertex(U),vertex(V),not(edge(U,V))]).
pr_rule(not(o_chosen1(U,V)),[vertex(U),vertex(V),edge(U,V),other(U,V)]).
...
pr_rule(not(o_edge3(_X0,_X1)),[_X0=2,_X1\=3]).
pr_rule(not(o_edge4(_X0,_X1)),[_X0\=3]).
pr_rule(not(o_edge4(_X0,_X1)),[_X0=3,_X1\=4]).
pr_rule(not(o_edge5(_X0,_X1)),[_X0\=4]).
pr_rule(not(o_edge5(_X0,_X1)),[_X0=4,_X1\=0]).
pr_rule(not(o_edge6(_X0,_X1)),[_X0\=4]).
pr_rule(not(o_edge6(_X0,_X1)),[_X0=4,_X1\=1]).
pr_rule(not(o_edge7(_X0,_X1)),[_X0\=4]).
pr_rule(not(o_edge7(_X0,_X1)),[_X0=4,_X1\=2]).
pr_rule(not(o_edge8(_X0,_X1)),[_X0\=4]).
pr_rule(not(o_edge8(_X0,_X1)),[_X0=4,_X1\=3]).
pr_rule(not(edge(_X0,_X1)),[not(o_edge1(_X0,_X1)),not(o_edge2(_X0,_X1)),not(o_edge3(_X0,_X1)),not(o_edge4(_X0,_X1)),not(o_edge5(_X0,_X1)),not(o_edge6(_X0,_X1)),not(o_edge7(_X0,_X1)),not(o_edge8(_X0,_X1))]).
...
pr_rule(not(o__chk31(U,V)),[vertex(U),vertex(V),not(edge(U,V))]).
pr_rule(not(o__chk31(U,V)),[vertex(U),vertex(V),edge(U,V),other(U,V)]).
pr_rule(not(o__chk31(U,V)),[vertex(U),vertex(V),edge(U,V),not(other(U,V)),chosen(U,V)]).
